 ...
 */
final class Version20211004081847 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE transaction (id INT AUTO_INCREMENT NOT NULL, crypto_id INT NOT NULL, wallet_id INT DEFAULT NULL, user_id INT NOT NULL, uuid BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', quantity INT NOT NULL, originalprice NUMERIC(10, 2) NOT NULL, daylyvalue NUMERIC(30, 10) DEFAULT NULL, UNIQUE INDEX UNIQ_723705D1D17F50A6 (uuid), INDEX IDX_723705D1E9571A63 (crypto_id), INDEX IDX_723705D1712520F3 (wallet_id), INDEX IDX_723705D1A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE valorisation (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, date DATE NOT NULL, soldeinitial DOUBLE PRECISION NOT NULL, soldeofday DOUBLE PRECISION NOT NULL, INDEX IDX_5B724312A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE valorisation ADD CONSTRAINT FK_5B724312A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE valorisation DROP FOREIGN KEY FK_5B724312A76ED395');
        ...
        $this->addSql('DROP TABLE valorisation');
